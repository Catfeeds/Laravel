...
class ProjectForPublisherTransformer extends TransformerAbstract
{
    public function transform(Project $project)
    {
        ...
        $extra = [
            ...
            'remittance_submitted_at'   => $project->remittance_submitted_at ? $project->remittance_submitted_at->toDateTimeString() : '',

            // 甲方填写的设计费发放方案
            'payment_remark'            => (string)$project->payment_remark,
            'payment_remark_updated_at' => $project->payment_remark_updated_at ? $project->payment_remark_updated_at->toDateTimeString() : '',
